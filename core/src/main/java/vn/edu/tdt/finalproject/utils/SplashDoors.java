...
public class SplashDoors {
    private static Texture splashDoorLeft;
    private static Texture splashDoorRight;
    private static float[] doorDirectionX;
    private static TextNoBackground loadingText;

    public static void loadResources(){
         splashDoorLeft= new Texture("images/backgrounds/splashdoor.png");
         splashDoorRight = new Texture("images/backgrounds/splashdoor.png");

         float screenHalfWidth = Gdx.graphics.getWidth() /2f;
         doorDirectionX = new float[]{0, screenHalfWidth};

         loadingText = new TextNoBackground(Color.GOLD, 30);
    }
